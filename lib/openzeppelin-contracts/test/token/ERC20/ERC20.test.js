    ...
    describe(`using ${Token._json.contractName}`, function () {
      ...
      describe('_mint', function () {
        ...
        describe('for a non zero account', function () {
          ...
          it('increments collateral', async function () {
            const expectedSupply = initialSupply.add(value);
            expect(await this.token.collateral()).to.be.bignumber.equal(expectedSupply);
          });
        ...
        describe('for a non zero account', function () {
          ...
          const describeBurn = function (description, value) {
            describe(description, function () {
              ...
              it('decrements collateral', async function () {
      ...
      describe('_update', function () {
        ...
        it('from is the zero address', async function () {
          ...
          const collateral = await this.token.collateral();
          ...
          expect(await this.token.collateral()).to.be.bignumber.equal(collateral.add(value));
        ...
        it('to is the zero address', async function () {
          ...
          expect(await this.token.collateral()).to.be.bignumber.equal(collateral.sub(value));
        ...
        it('from and to are the zero address', async function () {
          ...
          expect(await this.token.collateral()).to.be.bignumber.equal(collateral);

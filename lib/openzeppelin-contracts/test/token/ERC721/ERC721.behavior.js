  ...
  context('with minted tokens', function () {
    ...
    describe('collateral', function () {
      it('returns total token supply', async function () {
        expect(await this.token.collateral()).to.be.bignumber.equal('2');
      });
    });
    ...
    describe('tokenByIndex', function () {
      ...
      [firstTokenId, secondTokenId].forEach(function (tokenId) {
        it(`returns all tokens after burning token ${tokenId} and minting new tokens`, async function () {
          ...
          expect(await this.token.collateral()).to.be.bignumber.equal('3');
    ...
    context('with minted tokens', function () {
      ...
      context('with burnt token', function () {
        ...
        it('burns all tokens', async function () {
          ...
          expect(await this.token.collateral()).to.be.bignumber.equal('0');
